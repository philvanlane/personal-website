    ...
    return (
        <div className="about-content container">
            ...
            <div className="about-desc">
                ...
                <br></br>
                <p>
                I am in my final year as a PhD candidate in the David A. Dunlap Department of Astronomy & Astrophysics at University of Toronto, and a Visiting Graduate Student at University of California San Diego. My research is focused on developing statistical, machine learning, and AI methodologies to study variability in low mass stars, with the goal of improving age constraints for exoplanet hosts. My thesis advisors are Drs. Joshua S. Speagle (沈佳士) and Gwendolyn Eadie from U of T, and Dr. Ryan Cloutier from McMaster University, and my host at UCSD is Dr. Chris Theissen.
